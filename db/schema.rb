...
ActiveRecord::Schema.define(version: 20151117060851) do
  ...
  create_table "authorizations", force: :cascade do |t|
    t.string   "open_id",       limit: 255,                comment: "open id"
    t.string   "provider",      limit: 255,                comment: "提供者(wx,weibo)"
    t.string   "token",         limit: 255,                comment: "令牌"
    t.string   "refresh_token", limit: 255,                comment: "刷新令牌"
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.string   "category",      limit: 255,                  null: false, comment: "商品分类,\"饮料\""
    t.integer  "status",        limit: 4,   default: 1,      null: false
